...
namespace Adrenalin.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create enum types safely — skips if already exists (DB was pre-seeded via DDL script)
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ai.agent_rating AS ENUM ('relevant', 'moderately_relevant', 'not_relevant'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ai.suggestion_type AS ENUM ('troubleshooting_steps', 'similar_tickets'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE auth.revocation_reason AS ENUM ('logout', 'suspicious_reuse', 'admin_force', 'role_change'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE company.deployment_model AS ENUM ('cloud', 'on_premise', 'hybrid'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE gamification.badge_tier AS ENUM ('bronze', 'silver', 'gold', 'platinum'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE gamification.period_type AS ENUM ('daily', 'weekly', 'monthly', 'all_time'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE notification.delivery_status AS ENUM ('sent', 'failed', 'bounced', 'pending'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE notification.notification_channel AS ENUM ('email', 'in_app', 'sms'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE sla.trigger_event AS ENUM ('ticket_created', 'ticket_updated', 'time_based'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ticket.ticket_priority AS ENUM ('urgent', 'high', 'medium', 'low'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ticket.ticket_source AS ENUM ('email', 'portal', 'phone'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ticket.ticket_status AS ENUM ('new', 'open', 'in_progress', 'pending_customer', 'pending_internal', 'on_hold', 'product_roadmap', 'pending_approval', 'compliance_review', 'dual_agent_confirm', 'resolved', 'reopened', 'closed'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");
            migrationBuilder.Sql(@"DO $$ BEGIN CREATE TYPE ticket.ticket_type AS ENUM ('bug', 'enhancement', 'incident', 'change_request', 'query', 'service_request', 'clarification', 'environment_issue'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;");

            // Create sequence safely — skips if already exists
            migrationBuilder.Sql(@"CREATE SEQUENCE IF NOT EXISTS ticket.ticket_number_seq START WITH 1 INCREMENT BY 1 NO CYCLE;");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by = table.Column<Guid>(type: "uuid", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    TicketStatusGraphId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("status_transitions_pkey", x => x.id);
                    table.ForeignKey(
                        name: "FK_status_transitions_ticket_status_graphs_TicketStatusGraphId",
                        column: x => x.TicketStatusGraphId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ticket_status_graph_scopes_ticket_status_graphs_TicketStatu~",
                        column: x => x.TicketStatusGraphId,
                        principalSchema: "workflow",
                        principalTable: "ticket_status_graphs",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    priority_score_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Timestamp of last priority score computation. Re-evaluation loop updates this on every customer reply or SLA status change."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tickets_ticket_status_graphs_TicketStatusGraphId",
                        column: x => x.TicketStatusGraphId,
                        principalSchema: "workflow",
                        principalTable: "ticket_status_graphs",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    keyword_matches = table.Column<List<string>>(type: "text[]", nullable: true),
                    ...
                    resolution_sent_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    matched_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_status_transitions_TicketStatusGraphId",
                schema: "workflow",
                table: "status_transitions",
                column: "TicketStatusGraphId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_attachments_TicketCommentId",
                schema: "ticket",
                table: "ticket_attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_status_graph_scopes_TicketStatusGraphId",
                schema: "workflow",
                table: "ticket_status_graph_scopes",
                column: "TicketStatusGraphId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tickets_TicketStatusGraphId",
                schema: "ticket",
                table: "tickets",
                column: "TicketStatusGraphId");
