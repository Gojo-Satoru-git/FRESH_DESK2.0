...
public sealed class LinkTicketsCommandHandler : IRequestHandler<LinkTicketsCommand, Guid>
{
    private readonly ITicketRepository _ticketRepository;

    public LinkTicketsCommandHandler(ITicketRepository ticketRepository)
    {
        _ticketRepository = ticketRepository;
    }

    public async Task<Guid> Handle(LinkTicketsCommand request, CancellationToken cancellationToken)
    {
