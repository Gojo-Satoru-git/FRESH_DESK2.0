...
@Component({
  ...
  template: `
    ...
    >
      <div class="bg-surface p-8 rounded-xl shadow-lg text-center max-w-md w-full">
        <div
          class="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-4 text-2xl"
        >
          🎧
        </div>
        <h1 class="text-2xl font-bold text-text-main mb-2">Agent Dashboard</h1>
        <p class="text-text-muted mb-6">Welcome to the internal support queue.</p>
